...
class listWiseCard extends StatefulWidget {
  final String id;
  final String name;
  ...
  @override
  _listWiseCardState createState() => _listWiseCardState();
}

class _listWiseCardState extends State<listWiseCard> {
  ...
  // Compact view (default: ID, name, and call button only)
