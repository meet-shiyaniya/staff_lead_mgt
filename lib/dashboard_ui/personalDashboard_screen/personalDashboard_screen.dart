...
class _DashboardScreenState extends State<PersonalDashboardScreen> with SingleTickerProviderStateMixin {
  String _selectedFilter = 'Daily'; // Time-based filter
  String _selectedCategory = 'Inquiry'; // Category filter
