...
import '../staff_Indetails_Screen.dart';

class inactiveStaffScreen extends StatefulWidget {
  ...
  inactiveStaffScreen({
    ...
    required this.inactiveStaffList

  });

  @override
  State<inactiveStaffScreen> createState() => _inactiveStaffScreenState();
}

class _inactiveStaffScreenState extends State<inactiveStaffScreen> {
  @override
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Icon(Icons.block, size: 22, color: appColor.bodymainTxtColor,),

                SizedBox(width: 10,),

                Text("Inactive Staff Details", style: TextStyle(color: appColor.bodymainTxtColor, fontSize: 15, fontWeight: FontWeight.bold, fontFamily: "poppins_thin"),),
            ...
            Expanded(
              ...
              child: ListView.builder(
                ...
                itemCount: widget.inactiveStaffList.length,

                itemBuilder: (context, index) {

                  final staff = widget.inactiveStaffList[index];
