...
import 'package:hr_app/Screen/HR%20Screens/Staff/Add%20Staff%20Menu%20Screens/add_Staff2_Screen.dart';

class addStaff1Screen extends StatefulWidget {
  @override
  _addStaff1ScreenState createState() => _addStaff1ScreenState();
}

class _addStaff1ScreenState extends State<addStaff1Screen> {
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => addStaff2Screen()));
